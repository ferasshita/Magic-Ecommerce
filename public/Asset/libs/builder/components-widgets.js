...
Vvveb.ComponentsGroup['Widgets'] = ["widgets/products", "widgets/blog", "widgets/browse", "widgets/countTable", "widgets/tableView", "widgets/googlemaps", "widgets/embed-video", "widgets/chartjs",/* "widgets/facebookpage", */"widgets/paypal", /*"widgets/instagram",*/ "widgets/x", "widgets/openstreetmap"/*, "widgets/facebookcomments"*/];

          Vvveb.Components.extend("_base", "widgets/products", {
              name: "products",
              attributes: ["data-component-products"],
              image: "icons/product.svg",
              dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.svg">',
              html: '<div data-component-products><div onload="item_view(this,\'\')"></div></div>',
          	...
          	init: function (node)
          	{
          		...
          		$(".component-properties input[name=collection]").val(this.collection);
          	},
              ...
              onChange: function (node, property, value) {
          		...
          		mapurl = "item_view(this,'" + this.collection + "')";
