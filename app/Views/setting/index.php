...
<div class="wrapper animate-bottom" id="wrapper_id">
				...
				<div class="d-flex align-items-center">
					<div class="mr-auto">
						<h3 class="page-title"><strong><?php
								if($pid == NULL){echo langs("settings");}else{echo lang($pid);}
								?></strong></h3>
	...
	<?php }?>
	<li>
		<a href="<?php echo base_url(); ?>setting?pid=location" class="hover-effect waves-effect waves-light nav-link rounded push-btn">
			<i class="fa fa-location-arrow"></i>
			<span><?php echo langs('location'); ?></span>
			<span class="pull-right-container"><i class="fa fa-angle-right pull-right"></i></span>
		</a>
	</li>
	<li>
		...
		<?php if($_ENV['DELETE_ACCOUNT'] == "TRUE" && $_SESSION['account_type'] == "admin"){ ?>
		<li>
		...
		<?php } ?>
		<?php if($_ENV['DELETE_DATABASE'] == "TRUE" && $_SESSION['account_type'] == "admin"){ ?>
		<li>
