...
$remote_file_url = 'http://localhost/software/server_test/project.zip'; #example: http://flippenmusic.com/v25.zip
// rename version location/name
$local_file = '../project.zip'; #example: version/new-version.zip
//
// version check information
//
// url to external verification of version number as a .TXT file
$ext_version_loc = "http://localhost/software/server_test/current_version.txt"; #example: http://flippenmusic.com/version/current_version.txt
